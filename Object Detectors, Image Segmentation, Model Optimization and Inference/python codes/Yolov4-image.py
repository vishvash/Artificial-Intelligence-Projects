...
img_to_detect = cv2.imread('C:/Users/Lenovo/Downloads/Study material/AI/Object Detectors, Image Segmentation, Model Optimization and Inference/Images/plane.jpg')
...
yolo_model = cv2.dnn.readNetFromDarknet('C:/Users/Lenovo/Downloads/Study material/AI/Object Detectors, Image Segmentation, Model Optimization and Inference/Assignment/yolov4.cfg','C:/Users/Lenovo/Downloads/Study material/AI/Object Detectors, Image Segmentation, Model Optimization and Inference/Assignment/yolov4.weights')
...
# yolo_output_layer = [yolo_layers[layer_id - 1] for layer_id in yolo_model.getUnconnectedOutLayers()]
