...
df = pd.read_csv(r'C:/Users/Lenovo/Downloads/Study material/AI/ANN, CNN, RNN Preliminaries/Assignment/breast_cancer.csv')
...
features = df.iloc[:, 1:]
labels = pd.DataFrame(df['diagnosis'])
...
x_val = x_train[:90]
partial_x_train = x_train[90:]
y_val = y_train[:90]
partial_y_train = y_train[90:]
